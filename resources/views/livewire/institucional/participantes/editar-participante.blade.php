<div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50" 
     ...
     wire:click.self="$dispatch('cerrar-modal-editar')">
    ...
    <div class="relative top-20 mx-auto p-5 border w-11/12 md:w-3/4 lg:w-1/2 shadow-lg rounded-md bg-white"
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h3 class="text-2xl font-bold text-gray-900">Editar Participante</h3>
                <p class="text-sm text-gray-600 mt-1">{{ $participante->user->name ?? 'Participante' }}</p>
            </div>
        ...
        <form wire:submit.prevent="actualizar" class="space-y-6">
            ...
            {{-- Email --}}
            <div>
                <label for="email_edit" class="block text-sm font-medium text-gray-700 mb-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {{-- Teléfono --}}
                <div>
                    <label for="telefono_edit" class="block text-sm font-medium text-gray-700 mb-2">
                        Teléfono
                    </label>
                    <input type="text" 
                           wire:model="telefono" 
                ...
                {{-- Cargo --}}
                <div>
                    <label for="cargo_edit" class="block text-sm font-medium text-gray-700 mb-2">
                        Cargo
                    </label>
                    <input type="text" 
                           wire:model="cargo" 
            ...
            {{-- Fecha de Ingreso --}}
<div>
                <label for="fecha_ingreso_edit" class="block text-sm font-medium text-gray-700 mb-2">
                    Fecha de Ingreso <span class="text-red-500">*</span>
                </label>
                <input type="date" 
                       wire:model="fecha_ingreso" 
                       id="fecha_ingreso_edit"
            ...
            <div class="flex items-center">
                ...
                <label for="activo_edit" class="ml-2 block text-sm text-gray-700">
                    Participante activo
                </label>
            </div>
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-blue-700">
                            <ul class="list-disc pl-5 space-y-1">
                                ...
                                <li>Si cambias el email, el participante deberá usar el nuevo email para iniciar sesión</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex items-center justify-end space-x-4 pt-6 border-t border-gray-200">
                ...
                <button type="submit" 
                        ...
                        class="inline-flex items-center px-6 py-2 bg-gradient-to-r from-green-600 to-emerald-600 border border-transparent rounded-lg font-medium text-white hover:from-green-700 hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200">
                    
                    <svg wire:loading wire:target="actualizar" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" fill="none" viewBox="0 0 24 24">
                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
                    
                    <span wire:loading.remove wire:target="actualizar">Actualizar Participante</span>
...
document.addEventListener('livewire:init', () => {
    ...
    Livewire.on('participante-actualizado', () => {
